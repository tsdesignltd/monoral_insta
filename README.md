...
Drive画像が非公開、またはHEICなどGraph APIが受け付けない形式の場合、投稿は失敗します。その場合はキュー内にエラーを表示します。ストーリーズ投稿ではInstagram APIの仕様上、キャプションと写真への撮影者タグ付けは送信しません。
...
- Instagram Graph APIによるフィード投稿、ストーリーズ投稿
